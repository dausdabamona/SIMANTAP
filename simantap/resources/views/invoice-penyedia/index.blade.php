@extends('layouts.app')
@section('title', 'Invoice Penyedia')
@push('styles')
...
<div class="container-fluid px-4">
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1">Invoice Penyedia</h4>
            <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active">Invoice Penyedia</li>
            </ol></nav>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="invoiceTable" class="table table-sm table-hover align-middle w-100">
...
const table = $('#invoiceTable').DataTable({
    ...
    ajax: {
        url: '{{ route('invoice-penyedia.index') }}',
        data: d => { d.tahun = $('#filterTahun').val(); }
    },
    columns: [
        { data: 'DT_RowIndex', orderable: false, searchable: false },
        { data: 'periode_label' },
        { data: 'nama_penyedia', orderable: false },
        { data: 'nomor_invoice', defaultContent: '-' },
